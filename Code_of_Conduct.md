# OmniROM Code of Conduct v1.0
## Community

Omni is about innovation, new features, transparency, community, and freedom. Our goal is to experiment with Android development because we enjoy it. Omni isn’t better, just different. It’s another option for the billion Android users out there. Android (vs. iOS and every other mobile OS) has thrived on options as well as the gigantic, talented development community that has emerged to build those options. That’s the beauty of Android – that you can pick and choose from a smorgasbord of devices with varying features and functionality.

We want a productive, happy and agile community that can welcome new ideas in a complex field, improve every process where needed, and foster collaboration between groups with very different needs, interests and skills - both part of our community and the community-at-large.
...
Responsibility for the project starts with the "core team", who delegate specific responsibilities and the corresponding authority to a series of teams and individuals. The core team, or its delegated representative(s), will arbitrate in any dispute.
...
We invite anybody, from any company or project, to participate in any aspect of the project. Our community is open, and any responsibility can be carried by any contributor who demonstrates the required capacity and competence.
...
## Origin & Licensing
The OmniROM Code of Conduct is forked from the [UBuntu Code of Conduct v2.0](https://www.ubuntu.com/about/about-ubuntu/conduct) and licensed under the [Creative Commons Attribution-Share Alike 3.0 license](http://creativecommons.org/licenses/by-sa/3.0/). You may re-use it for your own project, and modify it as you wish, just please allow others to use your modifications and give credit to the Ubuntu Project!
